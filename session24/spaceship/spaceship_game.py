...
class Game(arcade.Window):
    def __init__(self):
        ...
        self.background = arcade.load_texture("spaceship\photos\image-from-rawpixel-id-12779138-png.png")
        self.GOVER_background = arcade.load_texture("spaceship\photos\image-from-rawpixel-id-12779138-png.png")
        self.WIN_background = arcade.load_texture("spaceship\photos\Daco_4568521.png")
        self.text = arcade.load_texture("spaceship\photos\Lovepik_com-450063859-blue game over text style effect.png")
